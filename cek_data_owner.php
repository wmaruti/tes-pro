...
<table class="table table-striped table-bordered" style="width:100%">
		...
		// $sql = "SELECT * FROM public.trx_bill limit 10 ";
            ...
            $sql = "SELECT a.userid,a.unitid,b.tenantid,b.nama,c.unitid from mst_bill_assignment a join tenancy_tenant b on a.userid=b.userid join rel_ownership_unit c on b.tenantid=c.tenantid where a.isactive=1 and a.unitid=c.unitid and c.isowner=1
			limit 15";	 	
